                         ...
                         const std::string& text)
{
	...
	if (toPlayer->isAccessPlayer() || (player->getStorageValue(24144, value) && value == 1)){
		player->sendTextMessage(MESSAGE_STATUS_SMALL, "You can't send a private message to a gamemaster. Use help chat.");
		return false;
	}
